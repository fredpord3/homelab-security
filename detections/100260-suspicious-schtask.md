...
✅ Confirmed firing 2025-12. The above schtasks invocation produced a Sysmon EventID 1 with the full command line preserved, stock 92052 matched, and custom 100260 fired at level 11. Alert visible in dashboard, recorded in `alerts.json`.
